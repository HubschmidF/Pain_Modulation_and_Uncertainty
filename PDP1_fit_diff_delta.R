...
write_xlsx(overviewDF,
           "PATH\\TO\\YOUR\\ANALYSIS\\FOLDER\\4_model_results\\Summary_Model3.xlsx",  # adapt
           col_names = TRUE)
...
write_xlsx(HyperDraws,
           "PATH\\TO\\YOUR\\ANALYSIS\\FOLDER\\M3_draws.xlsx",  # adapt
           col_names = TRUE)
...
write_xlsx(PPC_DF,
           "PATH\\TO\\YOUR\\ANALYSIS\\FOLDER\\M3_PPC_raw.xlsx",  # adapt
           col_names = TRUE)
...
write_xlsx(param_values,
           "PATH\\TO\\YOUR\\ANALYSIS\\FOLDER\\generating_values_delta.xlsx",  # adapt
           col_names = TRUE)
...
write_xlsx(simulated_choices,
           "PATH\\TO\\YOUR\\ANALYSIS\\FOLDER\\simulated_choices_delta.xlsx",  # adapt
           col_names = TRUE)
