...
write_xlsx(overviewDF,
           "PATH\\TO\\YOUR\\ANALYSIS\\FOLDER\\Summary_Model1.xlsx", # adapt
           col_names = TRUE)
...
write_xlsx(HyperDraws,
           "PATH\\TO\\YOUR\\ANALYSIS\\FOLDER\\M1_draws.xlsx",  # adapt
           col_names = TRUE)
...
write_xlsx(PPC_DF,
           "PATH\\TO\\YOUR\\ANALYSIS\\FOLDER\\M1_PPC_raw.xlsx",  # adapt
           col_names = TRUE)
